				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form"
							action="<%=basePath%>/sm/updatePermissionVO" id="updatePermissionVO"
							method="post">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">权限ID</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputEmail3"
										name="permissionId" placeholder="请输入权限名">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">权限修改人</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="permissionUpdatedName"
