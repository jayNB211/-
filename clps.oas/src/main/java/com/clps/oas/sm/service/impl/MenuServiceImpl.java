...
public class MenuServiceImpl implements IMenuService{
	...
	*/
	...
	/*
	 *(non-Javadoc)
	 * @see com.clps.oas.sm.service.IMenuService#queryMenuVO(java.lang.String, int)
	 */
		
	@Override
	public List<MenuVo> queryMenuVO(String key, int date) {
		
			
				return  menuMapper.queryMenuVO(key, date);
