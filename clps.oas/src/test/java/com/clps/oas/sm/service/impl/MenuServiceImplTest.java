...
public class MenuServiceImplTest extends SpringTestBase{
	...
	*/
	...
	public void testAddMenu() {
		Menu menu = new Menu("menumanage",8,1,0,"menumanage",1,"zzz",new Timestamp(new Date().getTime()),"admin",
	...
	public void testUpdateMenu() {
		Menu menu = new Menu(10,"menuman",8,1,0,"menumanage",1,"update",new Timestamp(new Date().getTime()),"admin",
				new Timestamp(new Date().getTime()),"admin",null,null);
	...
	public void testUpdateMenuState() {
		Menu menu = new Menu(10,"menumanage",8,1,0,"menumanage",1,"update",new Timestamp(new Date().getTime()),"admin",
				new Timestamp(new Date().getTime()),"admin",null,null);
	...
	public void testQueryMenuVO() {
		...
		log.info(mm.queryMenuVO(null,30).size());
	}
