...
public class SendEmail implements Serializable{
	...
	*/ 
	 ...
	 */
	public final Integer getEmailRecipientId() {
	 ...
	 */
	public final void setEmailRecipientId(Integer emailRecipientId) {
	...
	public String toString() {
		return "SendEmail [emailId=" + emailId + ", emailSubject=" + emailSubject + ", emailRecipient=" + emailRecipient
				+ ", emailRecipientId=" + emailRecipientId + ", emailSendtime=" + emailSendtime + ", emailStatus="
				+ emailStatus + ", emailDefault1=" + emailDefault1 + ", emailDefault2=" + emailDefault2
				+ ", emailIsVisable=" + emailIsVisable + ", emailContent=" + emailContent + "]";
	}
