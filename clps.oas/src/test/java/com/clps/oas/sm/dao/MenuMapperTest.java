...
import com.clps.oas.sm.vo.MenuVo;
...
public class MenuMapperTest {
	...
	*/
	...
	public void testAddMenu() {
		Menu menu = new Menu("menumanage",1,1,0,"menumanage",1,"zzz",new Timestamp(new Date().getTime()),"admin",
				new Timestamp(new Date().getTime()),"admin",null,null);
		try {
	...
	public void testUpdateMenu() {
		...
		Menu menu = new Menu(1,"menu",2,1,0,"menu",1,"zzz",new Timestamp(new Date().getTime()),"admin",
				new Timestamp(new Date().getTime()),"admin",null,null);
		try {
	...
	public void testUpdateMenuState() {
		...
		Menu menu = new Menu(1,"menumanage",7,1,0,"menu",1,"zzz",new Timestamp(new Date().getTime()),"admin",
				new Timestamp(new Date().getTime()),"admin",null,null		);
		try {
	 ...
	 */
	@Test
	public void testQueryMenuVO() {
		
		try {
			
			MenuMapper mapper =session.getMapper(MenuMapper.class);
			List<MenuVo> menu1= mapper.queryMenuVO(null,0);
