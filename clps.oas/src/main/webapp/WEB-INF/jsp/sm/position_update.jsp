				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form"
							...
							method="post">
							<div hidden="hidden">
								<label for="inputEmail3">职位ID</label>
								<div>
									<input type="number" id="inputEmail3" name="positionId"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="positionName"
										name="positionName" placeholder="请输入姓名" onchange=" checkPositionname()"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea name="positionDescription" class="form-control"
										rows="5" id="positionDescription" placeholder="请输入部门描述" onchange="checkDescription()"><c:if
											test='${requestScope.position!=null}'>${requestScope.position.positionDescription}
</c:if></textarea>
								</div>
								<label for="inputPassword3" class="col-sm-2 control-label"></label>
								<div class="col-sm-10">
